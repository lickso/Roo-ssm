...
public class RealNameMsDesPlus {
	...
	public static void main (String[] args) throws Exception {
		...
		try {
			RealNameMsDesPlus desPlus = new RealNameMsDesPlus("RooBusi");
...
//			System.out.println(desPlus.decrypt(txt1));
			System.out.println(desPlus.decrypt("6fe2a4571701436e13828e353abcd8f8425d27712dff21ef"));
			System.out.println(desPlus.encrypt("211402198404268455"));
		}catch(Exception e) {
